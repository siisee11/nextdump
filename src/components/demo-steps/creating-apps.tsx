...
import { CheckCircleIcon, LoaderIcon, NextDumpIcon } from "@/components/icons";
import { APP_CREATION_PHASES, APP_CREATION_TOTAL_DURATION } from "@/lib/demo-config";

interface DemoCreatingAppsStepProps {
	onComplete: () => void;
}

/**
 * Step 3: Creating Apps
 * Animated component showing app creation progress (15 seconds)
 */
export function DemoCreatingAppsStep({ onComplete }: DemoCreatingAppsStepProps) {
		...
		<div className="h-full flex flex-col items-center justify-center p-8">
			<div className="w-full max-w-md flex flex-col items-center gap-6">
				...
				<div className="relative">
					...
					<NextDumpIcon className="size-16 text-primary relative z-10" />
				</div>

				{/* Title */}
				<div className="text-center">
					<h3 className="text-2xl font-bold mb-2">Creating NextRows Apps</h3>
